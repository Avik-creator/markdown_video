  ...
  return (
    <div className="space-y-5 py-4">
      ...
      <div className="flex items-center justify-between text-sm bg-zinc-800 rounded-lg p-3">
        ...
        <span className="text-zinc-400">Est. time: {estimatedTime(totalDuration, fps, quality)}</span>
      </div>

      {/* Export button */}
      <Button onClick={onExport} className="w-full gap-2 bg-pink-500 hover:bg-pink-600 text-white">
